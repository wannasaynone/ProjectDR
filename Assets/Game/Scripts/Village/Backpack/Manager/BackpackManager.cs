...
namespace ProjectDR.Village.Backpack
{
    ...
    /// 背包有最大格子數限制。
    /// 實作 IBackpackQuery 供其他 Installer 透過 VillageContext.BackpackReadOnly 查詢（ADR-003 D6）。
    /// </summary>
    public class BackpackManager : IBackpackQuery
    {
        ...
        // ===== IBackpackQuery 介面實作（ADR-003 D6）=====

        /// <summary>
        /// IBackpackQuery.HasItem — 判斷背包中是否有足夠數量的指定物品。
        /// </summary>
        ...
        /// <summary>
        /// IBackpackQuery.IsFull — 判斷背包是否已滿。
        /// 委派至 IsFull 屬性，供 ctx.BackpackReadOnly 查詢使用。
        /// </summary>
        bool IBackpackQuery.IsFull()
        {
            return IsFull;
        }
